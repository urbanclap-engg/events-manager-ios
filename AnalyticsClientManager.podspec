#
#  Be sure to run `pod spec lint AnalyticsClientManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "UrbanClap" => "engg-admin@urbanclap.com" }
  # Or just: s.author    = "Kanav Arora"
  # s.authors            = { "Kanav Arora" => "kanavarora@urbanclap.com" }
  # s.social_media_url   = "http://twitter.com/Kanav Arora"
